...
async def app_select_inline_dynamic():
    ...
    buttons.append([InlineKeyboardButton("ℹ️ How to Use", callback_data="how_to_use")])
        ...
        try:
            await context.bot.send_message(
                ...
                text=(
                    ...
                    f"╚══════════════════╝\n\n"
                    f"👇 Number নিতে এই command দিন:\n\n"
                    f"📞 /get"
                ),
                reply_markup=InlineKeyboardMarkup([[
                    InlineKeyboardButton("📞 Get Number", callback_data="welcome_get_number")
                ]])
            )
        except Exception:
            pass
...
async def callback_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "welcome_get_number":
        await do_get_number(query.message, user_id, count=1, user_name=user_name, bot=context.bot)
        return
