...
def after_number_inline(number, range_val):
    return InlineKeyboardMarkup([
        [InlineKeyboardButton("🔍 Check OTP", url="https://t.me/+SWraCXOQrWM4Mzg9")],
        [InlineKeyboardButton("🔄 Change Number", callback_data=f"same_{range_val}")],
...
async def auto_otp_multi(message, numbers, user_id, range_val, bot=None):
    ...
    async def on_otp(otp, n, raw_otp, found_country, found_app):
        ...
        # ✅ User কে দেখাও শুধু current number হলে
    ...
    async def _run():
        ...
        # ✅ stop_event set হলে অথবা 300 সেকেন্ড পর বন্ধ
        try:
