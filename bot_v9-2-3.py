...
async def app_select_inline_dynamic():
    """Dynamic app buttons — Facebook S1/S2 fixed + console থেকে max 5টা random"""
    dynamic_apps = await get_dynamic_apps()
    buttons = [
        [InlineKeyboardButton("• 🔵 Facebook S1", callback_data="app_s1_FACEBOOK")],
        [InlineKeyboardButton("• 🔵 Facebook S2", callback_data="app_s2_FACEBOOK")],
    ]
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # শুধু একটাই message — inline keyboard সহ
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if text in ("🟩 Start", "✧ Start", "🏠 Start", "/start"):
        # Reply keyboard সহ একটা ack পাঠাও তারপর start menu
        try:
            await update.message.delete()
        except Exception:
            pass
