...
#         MONGODB SETUP
# =============================================
MONGO_URI = os.environ.get("MONGO_URI", "mongodb+srv://shovosrb_db_user:ikuxhExaCVDXobqe@botservice.yjvl5nm.mongodb.net/?appName=Botservice")
_mongo_col = None
...
def get_db_col():
    ...
    if _mongo_col is None and MONGO_URI:
        try:
            ...
            client = MongoClient(MONGO_URI, serverSelectionTimeoutMS=8000, ssl_context=ctx)
