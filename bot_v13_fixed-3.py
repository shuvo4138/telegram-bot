        ...
        if res.status_code == 200:
            ...
            if data.get("meta", {}).get("code") == 200:
                ...
                for entry in otps:
                    ...
                    # পুরনো OTP skip — number assign এর আগের
                    if assign_time_ms and entry.get("time", 0) < assign_time_ms:
                        continue
                    # duplicate skip
                    ...
                    if num and clean_target and (
                        ...
                        logger.info(f"A2 OTP matched: {num} | otp_id: {otp_id} | time: {entry.get('time')}")
                        return entry
        return None
    except Exception as e:
