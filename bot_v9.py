...
def admin_keyboard_unified():
    ...
    return InlineKeyboardMarkup([
        ...
        # ── Row 3: Panels ──
        [
            InlineKeyboardButton("🟢 S1 Panel",     callback_data="admin_apistatus",     api_kwargs={"style": "success"}),
            InlineKeyboardButton("🟢 S2 Panel",     callback_data="admin_apistatus",     api_kwargs={"style": "success"}),
        ...
        # ── Row 5: Analytics & Reports ──
        [
            InlineKeyboardButton("📈 Analytics",    callback_data="s3admin_analytics",   api_kwargs={"style": "primary"}),
            InlineKeyboardButton("📑 Reports",      callback_data="admin_stats_s12",     api_kwargs={"style": "primary"}),
        ],
        # ── Row 6: Numbers ──
        [
        ...
        [
            ...
            InlineKeyboardButton("🔄 Reload",       callback_data="admin_refresh",       api_kwargs={"style": "primary"}),
        ],
        # ── Row 9: Danger Zone ──
        [
...
async def callback_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data.startswith("admin_"):
        ...
        if action == "clearcache":
            ...
            await safe_edit(query, "🧹 *Cache Cleared!*\n\notp_cache এবং join_cache পরিষ্কার হয়েছে।", parse_mode="Markdown")
            return
