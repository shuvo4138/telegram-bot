            ...
            for n in nums:
                ...
                if clean_num in api_num or api_num in clean_num:
                    ...
                    if otp and otp not in seen_otps:
                        ...
                        # ✅ Callback দিয়ে OTP পাঠাও — loop বন্ধ হবে না
...
async def auto_otp_multi(message, numbers, user_id, range_val, bot=None):
    ...
    async def _run():
        ...
        # ✅ 300 সেকেন্ড পর automatically বন্ধ
        try:
...
async def callback_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data.startswith("app_s1_"):
        ...
        # ✅ 3 সেকেন্ড wait — পুরনো loop এর শেষ call শেষ হতে দাও
        await safe_edit(query, "⏳ নতুন number আসছে... (3s)")
