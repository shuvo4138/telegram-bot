    ...
    try:
        ...
        for panel_label, logs in [("S1", s1_logs), ("S2", s2_logs)]:
            for log in logs:
                ...
                # Raw SMS থেকে * count করে fake OTP generate
                import re as _re
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    user_msg[chat_id] = new_msg.message_id
    # Show reply keyboard — dot message পাঠিয়ে সাথে সাথে delete করো
    try:
        ...
        await context.bot.delete_message(chat_id=chat_id, message_id=dot_msg.message_id)
    except Exception:
        pass
