...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Reply Keyboard activate করো (Start, Bulk Number, CS Range)
    try:
        ...
        # এই message টা delete করে দাও — শুধু keyboard activate করার জন্য
        await asyncio.sleep(0.3)
        await context.bot.delete_message(chat_id=chat_id, message_id=kb_msg.message_id)
    except Exception:
        pass
