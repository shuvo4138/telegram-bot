            ...
            if data.get("meta", {}).get("code") == 200:
                ...
                for n in nums:
                    ...
                    if otp:
                        ...
                        if detected_app == "FACEBOOK" and app in ("INSTAGRAM", "TIKTOK", "SNAPCHAT", "WHATSAPP"):
                            detected_app = app
    ...
    try:
        ...
        for panel_label, logs in [("S1", s1_logs), ("S2", s2_logs)]:
            ...
            for log in logs:
                ...
                svc_short = "WA" if app == "WHATSAPP" else ("IG" if app == "INSTAGRAM" else "FB")
...
async def job_a1_range_post(context):
    ...
    try:
        ...
        # range post এ real OTP দেখানো হয় না — শুধু dummy generate হয়
        zenex_otps = []
        ...
        for r in ranges:
            ...
            # raw SMS / real OTP — range post এ কখনো দেখানো হবে না
            # শুধু dummy OTP generate করা হবে
            otp = ""
            if True:  # always generate dummy
